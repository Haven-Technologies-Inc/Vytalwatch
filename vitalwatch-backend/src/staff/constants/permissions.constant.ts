...
export const PERMISSION_GROUPS: Record<PermissionCategory, PermissionType[]> = {
  ...
  [PermissionCategory.PATIENTS]: [
    ...
    Permission.PATIENTS_ASSIGN,
    Permission.PATIENTS_ENROLL,
  ],
  [PermissionCategory.PROVIDERS]: [
    ...
    Permission.PROVIDERS_ASSIGN,
  ],
  [PermissionCategory.ORGANIZATIONS]: [
  ...
  [PermissionCategory.DEVICES]: [
    ...
    Permission.DEVICES_ORDER,
    Permission.DEVICES_SYNC,
  ],
  [PermissionCategory.VITALS]: [
    Permission.VITALS_READ,
    Permission.VITALS_UPDATE,
    Permission.VITALS_DELETE,
    Permission.VITALS_EXPORT,
  ],
